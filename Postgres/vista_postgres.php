    ...
    <div class="row mt-5">
        <div class="col-md-7">
            <div class="card border-info">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-2">
                            <button class="btn btn-primary" onClick="CargarDatosGraficoBarP()">Generar</button>
                        </div>
        ...
        <div class="col-md-5">
            <div class="card border-success">
                ...
                <div class = "card-body">
                    <form action="insertar_postgres.php" method="post">
...
<script>
    ...
    function CargarDatosGraficoBarP(){
        $.ajax({
            url:'modelo_grafico_postgres.php',
            type: 'POST'
        }).done(function(resp){
            var nombre = [];
            var cantidad = [];
